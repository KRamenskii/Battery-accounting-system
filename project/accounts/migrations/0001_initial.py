    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('second_phone_number', models.CharField(blank=True, max_length=4, null=True)),
                ...
                ('subdepartment', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='accounts.subdepartment')),
            ],
            options={
                'verbose_name': 'user',
